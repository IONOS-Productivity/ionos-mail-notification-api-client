...
All URIs are relative to *https://<API_SPEC_HOST>/easynextcloud-mail-notification*
...
-g php \
--skip-validate-spec \
--additional-properties=invokerPackage=IONOS\\MailNotificationAPI\\Client,composerPackageName=ionos-productivity/ionos-mail-notification-api-client,licenseName=AGPL-3.0-or-later \
-o /local/
```
