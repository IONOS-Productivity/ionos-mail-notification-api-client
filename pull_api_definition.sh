...
# Initialize authentication CLI arguments
auth_cli_args=""

# Set authentication CLI arguments if user and password are provided
...
curl --progress-bar "${auth_cli_args}" --insecure "${API_SPEC}" > "${temp_file}"
